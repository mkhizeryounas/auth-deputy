...
router.get("/", locker.unlock("permission_read"), async (req, res, next) => {
  try {
...
router.get("/:id", locker.unlock("permission_read"), async (req, res, next) => {
  try {
...
router.post("/", locker.unlock("permission_write"), async (req, res, next) => {
  try {
...
router.put(
  "/:id",
  locker.unlock("permission_write"),
  async (req, res, next) => {
    try {
